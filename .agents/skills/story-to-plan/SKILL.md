...
argumentHint: "<story-id> <story-source> [notes-source]"
...
1. Read the repository instructions and the shared input, artifact, dependency, and blocking contracts.
...
14. Write the implementation plan and the handoff artifact.
